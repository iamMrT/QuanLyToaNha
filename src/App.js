...
function App() {
  return (
    <Routes>
      ...
      <Route path="/monthly-fee-statistics" element={<MonthlyFeeStatistics />}></Route>
      <Route path="/monthly-statistics" element={<MonthlyStatistics />}></Route>
      <Route path="/equipment" element={<Equipment />}></Route>

      <Route path="/service-registration/companies" element={<ServiceRegistration_Company />}></Route>
