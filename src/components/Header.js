...
const Header = () => {
    ...
    return (isLogout) ? <Outlet to='/logout?redirect=true' /> : (
                        ...
                        <ul className="nav__list">
                            ...
                            <li className="nav__item dropdown">
                                ...
                                <ul className="dropdown__menu">
                                    <li className="dropdown__item">
                                        <Link className="nav__link link__item" to='/building' onClick={() => linkAction('about', true)}>
                                            Tòa nhà
                                        </Link>
                                    </li>
                                    <li className="dropdown__item">
                                    ...
                                    <li className="dropdown__item">
                                        <Link className="nav__link link__item" to='/equipment' onClick={() => linkAction('about', true)}>
                                            Trang thiết bị
                                        </Link>
                                    </li>
                                    <li className="dropdown__item">
                            ...
                            <li className="nav__item dropdown">
                                ...
                                <ul className="dropdown__menu">
                                    ...
                                    <li className="dropdown__item">
                                        <Link className="nav__link link__item" to='/operating-costs' onClick={() => linkAction('about', true)}>
                                            Chi phí vận hành
                                        </Link>
                                    </li>
                                    {/*
                            ...
                            <li className="nav__item dropdown">
                                ...
                                <ul className="dropdown__menu">
                                    ...
                                    <li className="dropdown__item">
                                        <Link className="nav__link link__item" to='/feeemployee' onClick={() => linkAction('buildingemployee', true)}>
